...
public class PatientServiceTest {
    ...
    void setUp() {
        ...
        patientService = new PatientService(patientRepository, patientValidator, appointmentRepository, commandPattern);
    ...
    void testAddPatient_Success() {
        ...
        Optional<Patient> foundOptional = patientRepository.findById(2);
        Assertions.assertTrue(foundOptional.isPresent(), "Patient was not added correctly.");
    ...
    void testUpdatePatient_Success() {
        ...
        Optional<Patient> foundOptional = patientRepository.findById(1);
    ...
    void testUpdatePatient_FailsValidation() {
        ...
        Optional<Patient> foundOptional = patientRepository.findById(1);
        Assertions.assertTrue(foundOptional.isPresent(), "Patient not found after failed update.");
        Patient found = foundOptional.get();
