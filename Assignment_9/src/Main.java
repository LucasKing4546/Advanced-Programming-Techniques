...
public class Main {
    public static void main(String[] args) {
        ...
        PatientService patientService = new PatientService(patientRepository, patientValidator, appointmentRepository, commandPattern);
        AppointmentService appointmentService = new AppointmentService(appointmentRepository, appointmentValidator, commandPattern);

        UI ui = new UI(patientService, appointmentService, commandPattern);
        ui.run();
    }
    ...
    public static IRepository<Integer, Patient> readPropetriesInitPatientRepository (){
        try {
            ...
            InputStream is = new FileInputStream("Assignment_9/src/settings.properties");
            ...
            if (repoType.equals("binary")) {
                ...
                String connectionString = pr.getProperty("ConnectionURL");
                patientRepository = new PatientRepositoryDB(connectionString);
            } else if (repoType.equals("json")) {
                String patientRepoPath = pr.getProperty("PatientsPath");
                patientRepository = new PatientJSONFileRepository(patientRepoPath);
            } else {
                patientRepository = new PatientRepository();
                Patient patient1 = new Patient(1, "Ion Popescu", "ion.popescu@gmail.com", "0712345678", 45, "lower risk");
                Patient patient2 = new Patient(2, "Maria Ionescu", "maria.ionescu@yahoo.com", "0798765432", 60, "higher risk");
                Patient patient3 = new Patient(3, "Andrei Dumitru", "andrei.dumitru@gmail.com", "0723456789", 30, "lower risk");
                Patient patient4 = new Patient(4, "Elena Popa", "elena.popa@outlook.com", "0734567890", 23, "lower risk");
                Patient patient5 = new Patient(5, "Mihai Constantinescu", "mihai.const@yahoo.ro", "0745678901", 30, "lower risk");
    ...
    public static IRepository<Integer, Appointment> readPropetriesInitAppointmentRepository() {
        try {
            ...
            if (repoType.equals("binary")) {
                ...
                String connectionString = pr.getProperty("ConnectionURL");
                appointmentRepository = new AppointmentRepositoryDB(connectionString);
            } else if (repoType.equals("json")) {
                String appointmentRepoPath = pr.getProperty("AppointmentsPath");
                appointmentRepository = new AppointmentJSONFileRepository(appointmentRepoPath);
            }  else {
                appointmentRepository = new AppointmentRepository();
                Appointment appointment1 = new Appointment(1, 1, "2025-10-23", "10:00:00");
                Appointment appointment2 = new Appointment(2, 2, "2025-10-23", "11:30:00");
                Appointment appointment3 = new Appointment(3, 3, "2025-10-24", "09:00:00");
                Appointment appointment4 = new Appointment(4, 1, "2025-10-25", "14:00:00");
                Appointment appointment5 = new Appointment(5, 4, "2025-10-26", "16:30:00");
